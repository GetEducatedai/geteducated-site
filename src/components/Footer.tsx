...
const socialLinks = [
  ...
  {
    label: "TikTok",
    href: "https://tiktok.com/geteducated.ai",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/geteducatedai",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted text-sm mt-3 font-body">
              <a href="mailto:info@geteducated.ai" className="hover:text-ink transition-colors">
                info@geteducated.ai
              </a>
            </p>
          </div>
          ...
          <div>
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <button
                  type="submit"
                  className="w-full bg-ink text-white text-sm font-semibold py-2.5 rounded-full hover:opacity-90 transition font-display btn-press"
                >
                  Subscribe
                </button>
              </form>
          ...
          <div className="flex items-center gap-3 flex-wrap justify-center">
            {socialLinks.map((s) => (
              <a
                ...
                aria-label={s.label}
                className="text-muted hover:text-ink transition-colors hover:scale-110 transform duration-200"
              >
                {s.icon}
              </a>
            ))}

...
const cards = [
  {
    title: "Community",
    description:
      "A private network of AI builders, creators, and entrepreneurs. No lurkers. No fluff. Just people shipping.",
    icon: (
  ...
  },
  {
    title: "Academy",
    description:
      "Structured courses that actually teach you how to use AI to generate income. Not theory. Execution.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    title: "Templates",
    description:
      "Plug-and-play AI business templates. Proposals, workflows, automations — ready to deploy.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Find your co-founder. Your creative partner. Your first client. We connect builders.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    title: "Events",
    description:
      "In-person and virtual events. Masterminds, workshops, and retreats in Dubai, Tulum, and beyond.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "This isn't a course platform. It's the operating system for your AI-powered life.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
